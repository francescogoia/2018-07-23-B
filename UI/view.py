...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._txtIn_giorni = ft.TextField(label="xGiorni")
        self._btn_grafo = ft.ElevatedButton(text="Grafo", on_click=self._controller.handleGrafo)
        row1 = ft.Row([ft.Container(self._DD_anno, width=300), ft.Container(self._txtIn_giorni, width=300), ft.Container(self._btn_grafo, width=150)],
